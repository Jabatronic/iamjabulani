  ...
  */
  head: {
    ...
    link: [
      ...
      { rel: 'preload', href: 'https://fonts.googleapis.com/css?family=Raleway|Roboto|Roboto+Slab:600,400&display=swap', as: 'style' },
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Raleway|Roboto|Roboto+Slab:600,400&display=swap' }
    ],
    bodyAttrs: {
